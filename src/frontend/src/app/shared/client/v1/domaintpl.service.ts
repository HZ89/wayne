...
import { DomainTpl } from '../../model/v1/domaintpl';
import { isNotEmpty } from '../../utils';
import { PageState } from '../../page/page-state';

@Injectable()
export class DomainTplService {
  ...
  create(ingressTpl: DomainTpl, appId: number): Observable<any> {
    return this.http
      .post(`/api/v1/apps/${appId}/ingresses/tpls`, ingressTpl, this.options)
      .catch(error => Observable.throw(error));
  }

  update(ingressTpl: DomainTpl, appId: number): Observable<any> {
    return this.http
